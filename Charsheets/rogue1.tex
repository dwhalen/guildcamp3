...
\bigquote{``Trust is like a paper, once crumpled, it can’t be perfect again.''}{-- Unknown}
...
\begin{itemz}[Notes]
	\item Your magical affinity is earth. You draw strength from Gaia herself. Your CR is reduced by one while swimming.
...
\begin{contacts}
		\contact{\cNobleOne{}} Junior Secretariat of Arcane Research. \cNobleOne{They} has no magical ability. You don't understand how someone like \cNobleOne{them} could get \cNobleOne{their} job properly without magic, but will follow \cNobleOne{their} commands, since you both have a common goal.
		...
		\contact{\cMageOne{}} A mage who helped to create the portal to the other universe. You'll need to collect items for \cMageOne{\them}.
		\contact{\cMageTwo{}} A mage who helped to create the portal to the other universe. You'll need to collect items for \cMageTwo{\them}.
		\contact{\cRogueTwo{}} A member of base security. \cRogueTwo{They} is a fellow member of the Rogue's Guild. Shifty fellow.
\end{contacts}
