...
%% quote examples
\bigquote{``The needs of the many outweigh the needs of the few.''}{-- Spock}
...
In case things go wrong, some of your old friends \emph{did} send you a present long ago. It's a small necklace, but they say its specially made for your biosigns and will transport you to another world safely if anything ever happens to you. Until today, you'd just kept it as a nice heirloom, but now it seems it could actually be useful. If nothing else, it's started glowing since the start of this meeting. They said to make sure you were wearing it and had at least one unit of $\omega$, and it would save you from the end times. So whatever anyone else says about this whole end of the world, doesn't seem \emph{that} horrible to you - you've got a backup plan. 
