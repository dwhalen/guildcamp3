...
\NEW{PC}{\cSpecOpTwo}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bTechWorld{}\bTechMob{}}
	\s\MYgreens {\gLockpicking{}\gTrance{}}
	\s\MYabils {\aTest{}
		\aTestCombat{}
	}
	\s\MYitems {\iTest{}\nTest{}}
...
\NEW{PC}{\cRogueTwo}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bMagicWorld{}}
	\s\MYgreens {\gBlackMarket{}\gLockpicking{}}
	\s\MYabils {\aTest{}
		\aTestCombat{}
	}
	\s\MYitems {\iTest{}\nTest{}}
...
\NEW{PC}{\cTech}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bTechWorld{}}
	\s\MYgreens {\gSPublishing{}\gBatterycharge{}}
	\s\MYabils {\aTest{}
		\aTestCombat{}
	}
