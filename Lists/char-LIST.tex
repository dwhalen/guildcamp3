...
\NEW{PC}{\cSciOne}{
	...
	\s\MYabils {}
	\s\MYitems {\iScrewdriver{}\iMultitool{}\iDiamondDrill{}\iGraphiteLube{}\iFlashlight{}\iCompoundNine{}\iScienceLicenseOne{}}
...
\NEW{PC}{\cSciTwo}{
	...
	\s\MYgreens {\gSPublishing{}\gSaveWorld{}\gSaveTheWorldScientists{}\nEscapePodTech{}\nSciTwoRecipes{}}
	\s\MYabils {}
	\s\MYitems {\iMultitool{}\iScrewdriver{}\iScienceLicenseTwo{}}
	\s\MYwhites {\wProposal{}}
	\s\MYmems {\mBookTechPeople{}}
%	\s\MYnbs      {\nEscapePodTech{}}
    \newstat\MYbatt {$\omega$}{$\omega$}{5}
...
\NEW{PC}{\cPaladin}{
	...
	\s\MYitems {\iCauldron{}\iUnicornHoof{}\iPenicillin{}\iPenicillin{}}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}}
    \newstat\MYbatt {$\omega$}{$\omega$}{0}
