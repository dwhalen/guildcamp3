...
\NEW{PC}{\cSciOne}{
	...
	\s\MYplayer {Alexander Chu}
	\s\MYblues {\bTechWorld{}\bTechMob{}}
	\s\MYgreens {\gSPublishing{}\gSaveWorld{}\gSaveTheWorldScientists{}\nSciOneRecipes{}}
	\s\MYabils {}
	\s\MYitems {\iScrewdriver{}\iMultitool{}\iDiamondDrill{}\iGraphiteLube{}\iFlashlight{}\iCompoundNine{}}
...
\NEW{PC}{\cSciTwo}{
	\s\MYname	{Eluvia Cine}
	\s\MYfile	{sci2.TEX}
	\s\MYnumber {00002}
	\s\MYdesc {a scientist}
	\s\MYplayer {Alex Billinger}
	\s\MYblues {\bTechWorld{}}
	\s\MYgreens {\gSPublishing{}\gSaveWorld{}\gSaveTheWorldScientists{}\nEscapePodTech{}\nSciTwoRecipes{}}
	\s\MYabils {}
	\s\MYitems {\iMultitool{}\iScrewdriver{}}
	\s\MYwhites {\wProposal{}}
	\s\MYmems {\mBookTechPeople{}}
%	\s\MYnbs      {\nEscapePodTech{}}
    \newstat\MYbatt {$\omega$}{$\omega$}{5}
...
\NEW{PC}{\cMageTwo}{
	...
	\s\MYplayer {Katherine Naegele}
	\s\MYblues {\bMagicWorld{}}
	\s\MYgreens {\gMPublishing{}\gSaveWorld{}\gSaveTheWorldMages{}\nMagTwoRecipes{}}
	\s\MYabils {}
	\s\MYitems {\iCauldron{}\iPlumbicRod{}\iCursedTome{}}
	\s\MYwhites {\wProposal{}}
...
\NEW{PC}{\cNobleOne}{
	...
	\s\MYabils {}
	\s\MYitems {\iWerewolfFang{}\iUnicornHoof{}}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}}
    \newstat\MYbatt {$\omega$}{$\omega$}{0}
    \newstat\MYmana {$\alpha$}{$\alpha$}{0}
...
\NEW{PC}{\cNobleTwo}{
	\s\MYname	{Amelia Florence}
	\s\MYfile	{noble2.TEX}
	\s\MYnumber {00006}
	\s\MYdesc {a beautiful noble woman}
	\s\MYplayer {Hannah Lipsky}
	\s\MYblues {\bMagicWorld{}\bMagicMob{}}
	\s\MYgreens {\gSaveWorld{}\gYouAreFired{}\gSpeech{}}
	\s\MYabils {}
	\s\MYitems {}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}}
...
\NEW{PC}{\cSpecOpOne}{
	...
	\s\MYplayer {Kevin Ling}
	\s\MYblues {\bTechWorld{}}
	\s\MYgreens {\gLockpicking{}\gSaveWorld{}\gAddPartsTech{}}
	\s\MYabils {\aArmoryDoorTech{}}
	\s\MYitems {\iTechGun{}}
	\s\MYwhites {}
	\s\MYmems {\mBookTechPeople{}\mTechSaveOne{}\mTechSaveThree{}\mTechSaveFour{}\mTechSaveTwo{}}
	\s\MYcr {3}
...
\NEW{PC}{\cSpecOpTwo}{
	...
	\s\MYabils {\aArmoryDoorTech{}\aSellSecrets{}\aTrance{}}
	\s\MYitems {\iTranceDrug{}\iTranceDrug{}\iTranceDrug{}\iTechGun{}}
	\s\MYwhites {}
	\s\MYmems {\mBookTechPeople{}\mTechSaveOne{}\mTechSaveTwo{}\mTechSaveFive{}\mTechSaveThree{}}
	\s\MYcr {3}
    \newstat\MYbatt {$\omega$}{$\omega$}{2}
    \newstat\MYmana {$\alpha$}{$\alpha$}{0}
}
\NEW{PC}{\cRogueOne}{
	...
	\s\MYabils {\aArmoryDoorMagic{}}
	\s\MYitems {\iTechGun{}}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}\mMagicSaveTwo{}\mMagicSaveFour{}\mMagicSaveOne{}\mMagicSaveThree{}}
%	\s\MYnbs      {\nEscapePodMagic{}}
	\s\MYcr {3}
    \newstat\MYbatt {$\omega$}{$\omega$}{0}
...
\NEW{PC}{\cRogueTwo}{
	...
	\s\MYfile	{rogue2.TEX}
	\s\MYnumber {00012}
	\s\MYdesc {a strong-looking woman}
	\s\MYplayer {Fawnn}
	\s\MYblues {\bMagicWorld{}}
	...
	\s\MYitems {\iTechGun{}}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}\mRogueSelling{}\mMagicSaveOne{}\mMagicSaveTwo{}\mMagicSaveFive{}\mMagicSaveThree{}}
	\s\MYcr {3}
    \newstat\MYbatt {$\omega$}{$\omega$}{0}
    \newstat\MYmana {$\alpha$}{$\alpha$}{2}
}
\NEW{PC}{\cPaladin}{
	...
	\s\MYblues {\bMagicWorld{}}
	\s\MYgreens {\gSaveWorld{}\gManaRecharge{}\gWedding{}\gNewPaladin{}}
	\s\MYabils {\aTruthTelling{}}
	\s\MYitems {\iCauldron{}\iUnicornHoof{}\iPenicillin{}\iPenicillin{}\gSpeech{}}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}}
    \newstat\MYbatt {$\omega$}{$\omega$}{0}
...
\NEW{PC}{\cTech}{
	...
	\s\MYblues {\bTechWorld{}}
	\s\MYgreens {\gSPublishing{}\gBatterycharge{}\gSaveWorld{}\nTechWorldSave{}\gNewTech{}}
	\s\MYabils {}
	\s\MYitems {\iScrewdriver{}\iMultitool{}\iFlashlight{}}
	\s\MYwhites {}
	\s\MYmems {\mBookTechPeople{}}
