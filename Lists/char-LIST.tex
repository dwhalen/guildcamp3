...
\NEW{PC}{\cSpecOpOne}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bTechWorld{}}
	\s\MYgreens {\gLockpicking{}\gSaveWorld{}}
...
\NEW{PC}{\cSpecOpTwo}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bTechWorld{}\bTechMob{}}
	\s\MYgreens {\gLockpicking{}\gTrance{}\gSaveWorld{}\gBlackMarket{}}
...
\NEW{PC}{\cRogueOne}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bMagicWorld{}}
	\s\MYgreens {\gLockpicking{}\gSaveWorld{}\gPoem{}}
...
\NEW{PC}{\cRogueTwo}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bMagicWorld{}}
	\s\MYgreens {\gBlackMarket{}\gLockpicking{}\gSaveWorld{}}
	\s\MYabils {\aArmoryDoorMagic{}}
	\s\MYitems {\iTechGun{}}
	\s\MYwhites {}
	\s\MYmems {\mBookMagicPeople{}}
