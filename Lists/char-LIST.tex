...
\NEW{PC}{\cSpecOpTwo}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bTechWorld{}\bTechMob{}}
	\s\MYgreens {\gLockpicking{}\gTrance{}\gSaveWorld{}\gBlackMarket{}\gAddPartsTech{}\gSecrets{}}
...
\NEW{PC}{\cPaladin}{
	...
	\s\MYplayer {Test Player}
	\s\MYblues {\bMagicWorld{}}
	\s\MYgreens {\gSaveWorld{}\gManaRecharge{}\gWedding{}}
