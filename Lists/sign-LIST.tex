...
\NEW{Sign}{\sNobleTwoLocker}{
	\s\MYname	{Locker}
	\s\MYloc	{}
	\s\MYtext	{Only open if you are \cNobleTwo{} unless you know otherwise. This locker can be lock-picked (hard). You can break into it with a combined CR of 9. Bulky items may not be added.}
}
