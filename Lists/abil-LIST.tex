...
\NEW{Abil}{\aThrow}{
  ...
  \s\MYname	{Pickpocket}
  \s\MYtext	{You can see all the items anyone within one ZOC has on their person, 
  		and steal to two items concealed on their person (i.e.- not in their hands) 
  		without being detected. Nobody else notices that you're pickpocketing.}
  \s\MYeffect	{I pickpocket you. Show me every item you are carrying on your person,
  		and I may take some. You do not notice the items are missing for
  		five minutes, or until you try to use them, whichever happens first.
  		You can't remember how you lost the items.}
  }
