...
\NEW{Abil}{\aFiremansCarry}{
  ...
  %	\s\MYtext	{You can sell verifiable secrets. To sell a secret, give the person you are selling them to the item card with the secret on it and show them this ability. Make sure you get whatever it was you asked for in return!}
  %	\s\MYeffect	{I sell you a verifiable piece of information.}
  %}
