...
\NEW{Item}{\iInvisibilityCloak}{
	...
	\s\MYnumber	{10057}
	\s\MYtext	{This cloak enables the wearer to become invisible for five minutes or until they interact with a person or item. This means you can move around gamespace and here things, but no one sees you. Consume when used.}
}

\NEW{Item}{\iCloakingDevice}{
	\s\MYname	{Cloaking Device}
	\s\MYnumber	{10058}
	\s\MYtext	{Using this device renders the user invisible for five minutes or until they interact with a person or item. This means you can move around gamespace and here things, but no one sees you. Consume when used.}
}
