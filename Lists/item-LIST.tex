...
\NEW{ItemLabel}{\iSecretFive}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cNobleOne{\intro} is only alive because of his family's connections.}
}
...
\NEW{ItemLabel}{\iSecretSeven}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cPoliOne{\intro} has lost faith in human kind.}
}
...
\NEW{ItemLabel}{\iSecretTwelve}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cServant{\intro} isn't exactly entirely human.}
}
...
\NEW{ItemLabel}{\iSecretFourteen}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cPoliTwo{\intro} has ordered the death of someone in the past.}
}
