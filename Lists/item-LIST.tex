...
\NEW{ItemLabel}{\iSecretOne}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cSciOne{\intro} has been involved in some less than stellar activities.}
}
\NEW{ItemLabel}{\iSecretTwo}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cSciTwo{\intro} started university at age 15.}
}
\NEW{ItemLabel}{\iSecretThree}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cMageOne{\intro} is in love.}
}
\NEW{ItemLabel}{\iSecretFour}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cMageTwo{\intro}'s parents weren't really there fore \cMageTwo{\them}.
	}
}
\NEW{ItemLabel}{\iSecretFive}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cNobleOne{\intro} ???.}
}
\NEW{ItemLabel}{\iSecretSix}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cNobleTwo{\intro} has strong aspirations.}
}
\NEW{ItemLabel}{\iSecretSeven}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cPoliOne{\intro} ???.}
}
\NEW{ItemLabel}{\iSecretEight}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cRogueOne{\intro} ???.}
}
\NEW{ItemLabel}{\iSecretNine}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cRogueTwo{\intro} may not be in complete control of his actions.}
}
\NEW{ItemLabel}{\iSecretTen}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cPaladin{\intro} ???.}
}
\NEW{ItemLabel}{\iSecretEleven}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cTech{\intro} doesn't like war.}
}
\NEW{ItemLabel}{\iSecretTwelve}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cServant{\intro} ...}
}
\NEW{ItemLabel}{\iSecretThirteen}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cSpecOpOne{\intro} did poorly in school.}
}
\NEW{ItemLabel}{\iSecretFourteen}{
	\s\MYname	{Irrefutable Proof}
	\s\MYnumber	{10082}
	\s\MYtext	{This serves as irrefutable proof that \cPoliTwo{\intro} ???.}
}
