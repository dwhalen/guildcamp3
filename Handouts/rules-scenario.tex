...
\documentclass[sheet]{guildcamp3}
...
Somewhere in the multiverse, the people of two worlds have discovered that their universes are collapsing - one governed by technology and one by magic. In a last ditch attempt at salvation, they make a connection with a parallel world where they find... themselves. The people of two dying worlds must negotiate with their doubles before the already shifting fabric of space and time falls apart around them. 
We are presenting the LARP Double-crossed to you who wish to experience an afternoon of entertainment as you take part in two teams each attempting to save their world from cataclysm. 
...
\paragraph{Game Times:} Game runs from 2pm to 6pm on Saturday.
Surviving PCs are expected to be in-game for the entirety. Cleanup and Wrapup will immediately follow the end of game.
...
{\bf Headbands} represent doubles between worlds. Two people wearing the same color headband are obviously parallel in some way between \bTechWorld{} and \bMagicWorld{}. A player without a headband for some reason has no double.
...
{\bf Carrying items} There are a lot of items in this game. You are unfortunately only a mere person and cannot carry them all around with you even if you can carry a large number of little white cards. Bulky items follow normal rules. You should be reasonable in the number of non bulky items you can carry at once. It will become pretty obvious and you'll have trouble carrying more than 5-6 decent sized items at once. Roleplay reasonably with the number of items you have.

{\bf Lockers} In this game, each character has a locker. You can store small items in your locker, but not bulky ones. It is possible bulky items might be in your locker prior to game start - once you remove them you cannot put them back. There is not an infinite amount of space in your locker - you cannot store more than 5 items in it. 
...
\paragraph{Battery and Mana:} To represent your strength in ability to use either technology, magic or both, you have battery and mana levels. Specifically $\omega$ scores correspond to individual battery levels (ability to use technology) and $\alpha$ scores correspond to individual mana levels (ability to use magic). A character starts with their battery or mana fully charged and can use it to achieve certain things or interact with certain objects during the game. 

\paragraph{World Magi-Tech Level:} Due to the collision between two worlds the functionality of magic and technology are both a bit limited right now. Each player has a booklet which tells them when relevant magic or technology levels change. These are denoted by $\tau$ for current technology level and $\mu$ for current magic level. Various machinery, equipment, spells,... will only work with at least a certain magic or tech level supported by the world. Additionally, restraints only work when the level of the world to which the restraining character belongs is non-zero. The levels will also be written on the boards in 200-002 and 200-013 for reference if you prefer not to carry the booklet with you (it is your book of levels, and this is the only thing it contains).
...
\paragraph{Bags:} To search a character's bags, search that character.
You may not leave in-game items in an unattended bag.
...
weapon (melee or ranged).  A killing blow requires a 10-count (see
...
Ranged combat does not exist in this game. There are guns, but they serve as CR boosts only - they cannot shoot people. Some abilities, magical spells, technical devices... may effect people within a certain range though. This will be noted on the item/ability card. 
%\subsection{Bombs}
%
...
In this game, \aKnockOut{} has special rules. You may only knock out another player when your (the attacking player) side (magic or tech) has a non-zero level. The level represents how much magic or tech is currently working here at the portal. You will find the current level in your Book of Levels. At game start, both magic and tech are at 0. 
...
victim. Waylay \aKnockOut{} is subject to the same constraints as normal \aKnockOut{}.
...
\paragraph{Restraints:} Technical and magical items capable of restraining someone are freely available.  Make an item card for them. Like \aKnockOut{}, they only function when the respective magic or tech level is non-zero.
