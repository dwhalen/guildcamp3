...
\paragraph{World Magi-Tech Level:} Due to the collision between two worlds the functionality of magic and technology are both a bit limited right now. Each player has a booklet which tells them when relevant magic or technology levels change. These are denoted by $\tau$ for current technology level and $\mu$ for current magic level. Various machinery, equipment, spells,... will only work with at least a certain magic or tech level supported by the world. 
...
In this game, \aKnockOut{} has special rules. You may only knock out another
player when your (the attacking player) side (magic or tech) has a non-zero level. The level represents how much magic or tech is currently working here at the portal. You will find the current level in your Book of Levels. At game start, both magic and tech are at 0. 
